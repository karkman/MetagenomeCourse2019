...
|  |    **Lunch** |
| __*Afternoon*__  | Crashcourse into statistics of metagenomic data: Multivariate analysis and generalized linear models of overdispersed count data(R_for_overdispersed_data/Metagenomics_course.md#Setting up the R-environment and compiling data) (__Katariina__)|
